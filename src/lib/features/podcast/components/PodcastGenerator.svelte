                    ...
                    <div class="relative">
                        {#if showPodcastMenuId === podcast.id}
                            <div class="mb-2 flex justify-end">
                                ...
                                >
                                    <button 
                                        class="w-8 h-8 flex items-center justify-center rounded-full bg-white/90 backdrop-blur-sm shadow-lg hover:bg-white transition-colors"
                                        role="menuitem"
                                        aria-label="Download"
                                    ...
                                    <button 
                                        class="w-8 h-8 flex items-center justify-center rounded-full bg-white/90 backdrop-blur-sm shadow-lg hover:bg-red-50 transition-colors"
                                        role="menuitem"
                                        aria-label="Delete"
