...
<div class="min-h-[calc(100vh-4rem)] bg-gradient-to-br from-[#f5f6fa] to-[#ece9fc]">
	<nav class="flex items-center justify-between border-b border-transparent px-8 py-4 bg-transparent">
	<!-- Left: Brand/Logo -->
